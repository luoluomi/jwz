<template>  
    <view class="container">  
		...
		<view class="user-section">
			<image class="bg" src="http://39.98.154.16:8080/static/images/bg/userBg.png"></image>
			<view class="user-info-box" @click="navTo(url)">
				<view class="portrait-box">
					<image class="portrait" :src="user.avatarUrl || 'http://39.98.154.16:8080/static/missing-face.png'"></image>
				</view>
				<view class="info-box">
			...
			<view class="vip-card-box">
				<image class="card-bg" src="http://39.98.154.16:8080/static/vip-card-bg.png" mode=""></image>
				<view class="b-btn">
					0 元试用
				</view>
				<view class="tit">
				...
				<text class="e-m">万维好物</text>
				<text class="e-b">神兽保佑，代码无bug</text>
			</view>
		</view>
		...
		>
			<image class="arc" src="http://39.98.154.16:8080/static/arc.png"></image>
			...
			<!-- 个人积分和优惠券 -->
			<view class="tj-sction" style="margin-top: 3rpx;">
				<view class="tj-item">
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-pinglun-copy" iconColor="#ee883b" title="企业账户"></list-cell>
				<list-cell icon="icon-shoucang_xuanzhongzhuangtai" iconColor="#54b4ef" title="我的客服"></list-cell>
