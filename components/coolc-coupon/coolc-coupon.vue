...
.coupon-item {
	...
	.coupon-money {
		...
		.nick { width:100%; height:50upx; line-height:30upx; font-size:13px; color:#000000; }
		.tit { width:100%; height:50upx; line-height:50upx; font-size:13px; color:#000000; }
		.demand { width:100%; height:30upx; line-height:30upx; font-size:13px; color:#000000; }
		
		.layof { width:100%; height:48upx; line-height:30upx; font-size:44upx; color:#ff9000; font-weight:bold; }
		.end_time { width:100%; height:30upx; line-height:30upx; font-size:13px; color:#000000; }
	}
